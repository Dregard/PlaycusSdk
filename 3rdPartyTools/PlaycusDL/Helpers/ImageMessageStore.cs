...
namespace PlaycusDL {
    ...
    internal class ImageMessageStore {
        ...
        private readonly string cache = Application.temporaryCachePath + "/pdl/image_messages/";
        ...
        internal IEnumerator Prefetch(Action onSuccess, Action<string> onError, params string[] urls) {
            ...
            string error = null;
            var downloading = 0;
            var userMaxConcurrent = PDL.Instance.Settings.MaxConcurrentImageCacheFetches;
        ...
        private bool IsFull(){
            ...
            long limit = PDL.Instance.Settings.ImageCacheLimitMB * 1048576;
            long currentSize = 0;
