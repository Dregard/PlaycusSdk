    ...
    static class ClientInfo
    {
        ...
        private static string GetPlatform()
        {
            if (RuntimePlatformIs("OSXEditor") ||
                RuntimePlatformIs("OSXPlayer")) return PlaycusDL.Platform.MAC_CLIENT;
            if (RuntimePlatformIs("WindowsEditor") ||
                RuntimePlatformIs("WindowsPlayer")) return PlaycusDL.Platform.PC_CLIENT;
            if (RuntimePlatformIs("OSXWebPlayer")) return PlaycusDL.Platform.WEB;
            if (RuntimePlatformIs("OSXDashboardPlayer")) return PlaycusDL.Platform.MAC_CLIENT;
            if (RuntimePlatformIs("WindowsWebPlayer")) return PlaycusDL.Platform.WEB;
            if (RuntimePlatformIs("IPhonePlayer")) return PlaycusDL.Platform.IOS;
            if (RuntimePlatformIs("PS3")) return PlaycusDL.Platform.PS3;
            if (RuntimePlatformIs("XBOX360")) return PlaycusDL.Platform.XBOX360;
            if (RuntimePlatformIs("Android")) return PlaycusDL.Platform.ANDROID;
            if (RuntimePlatformIs("NaCL")) return PlaycusDL.Platform.WEB;
            if (RuntimePlatformIs("LinuxEditor") ||
                RuntimePlatformIs("LinuxPlayer")) return PlaycusDL.Platform.PC_CLIENT;
            if (RuntimePlatformIs("WebGLPlayer")) return PlaycusDL.Platform.WEB;
            if (RuntimePlatformIs("FlashPlayer")) return PlaycusDL.Platform.WEB;
            if (RuntimePlatformIs("MetroPlayerX86") ||
                ...
                if (SystemInfo.deviceType == UnityEngine.DeviceType.Handheld) {
                    return PlaycusDL.Platform.WINDOWS_MOBILE;
                } else {
                    return PlaycusDL.Platform.PC_CLIENT;
                }
            }
            if (RuntimePlatformIs("WP8Player")) return PlaycusDL.Platform.WINDOWS_MOBILE;
            if (RuntimePlatformIs("BB10Player") ||
                RuntimePlatformIs("BlackBerryPlayer")) return PlaycusDL.Platform.BLACKBERRY;
            if (RuntimePlatformIs("TizenPlayer")) return PlaycusDL.Platform.ANDROID;
            if (RuntimePlatformIs("PSP2")) return PlaycusDL.Platform.PSVITA;
            if (RuntimePlatformIs("PS4")) return PlaycusDL.Platform.PS4;
            if (RuntimePlatformIs("PSMPlayer")) return PlaycusDL.Platform.WEB;
            if (RuntimePlatformIs("XboxOne")) return PlaycusDL.Platform.XBOXONE;
            if (RuntimePlatformIs("SamsungTVPlayer")) return PlaycusDL.Platform.ANDROID;
            if (RuntimePlatformIs("tvOS")) return PlaycusDL.Platform.IOS_TV;
            if (RuntimePlatformIs("WiiU")) return PlaycusDL.Platform.WIIU;
            if (RuntimePlatformIs("Switch")) return PlaycusDL.Platform.SWITCH;

            return PlaycusDL.Platform.UNKNOWN;
        }
